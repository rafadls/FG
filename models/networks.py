...
class FeatureLoss(nn.Module):
    ...
    def __call__(self, out7_r, out14_r, out23_r, out7_f, out14_f, out23_f):
        self.lay0 = torch.nn.InstanceNorm2d(128, affine=False).cuda()
        self.lay1 = torch.nn.InstanceNorm2d(128, affine=False).cuda()
        self.lay2 = torch.nn.InstanceNorm2d(256, affine=False).cuda()
        ...
        return Total_loss, 0 , 0, 0#E1/self.coef1, E2/self.coef2, E3/self.coef3
...
class VGG19(nn.Module):
    ...
    def __init__(self):
        ...
        self.max2=nn.AvgPool2d(kernel_size=5, stride=2)
#64
